 ...
 * Driven by the animation clock `time` instead of independent intervals,
 * so it slows down when the tab is blurred.
 *
 * Copied verbatim from cc-src/components/Spinner/useStalledAnimation.ts.
 * No changes — this file is pure logic with no Ink dependencies.
 *
 * @module components/chat/spinner/use-stalled-animation
 */
