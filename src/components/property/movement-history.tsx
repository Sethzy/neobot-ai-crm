    ...
    <div className="rounded-2xl border border-border bg-card p-5 transition-shadow duration-200 hover:shadow-md">
      ...
      {agencyName ? (
        <div className="flex items-center gap-3 rounded-lg border border-border bg-muted/30 p-4">
          <AppIcon name="arrowRight" className="h-5 w-5 shrink-0 text-muted-foreground" />
          <div>
            <p className="text-sm font-medium text-foreground">{agencyName}</p>
        ...
        <div className="flex flex-col items-center gap-2 py-8 text-center">
          <AppIcon name="arrowRight" className="h-8 w-8 text-muted-foreground/60" />
