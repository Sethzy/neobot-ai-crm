/**
 * Vendored free, disposable, and consumer email providers from Twenty CRM.
 * @module lib/crm/free-email-providers
 */
...
export const FREE_EMAIL_PROVIDERS: ReadonlySet<string> = new Set(emailProviders.split("\n"));
