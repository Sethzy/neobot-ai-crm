...
> Source: [@Hxlfed14 on X](https://x.com/Hxlfed14/status/2028116431876116660)
...
And the single most underrated pattern inside these harnesses? **Progressive disclosure** — agents discovering context incrementally instead of drowning in everything upfront.
...
```
                        ┌─────────────────────────┐
                        │  Harness Assembles Input │
                        └────────────┬────────────┘
                                     ▼
                              ◆  LLM Call  ◆
                             ╱              ╲
                Returns text                 Returns tool call
                     ╱                              ╲
          ┌─────────────────┐              ┌──────────────────┐
          │ Response to User│              │   Execute Tool   │
          └─────────────────┘              └────────┬─────────┘
                                                    ▼
                                      ┌──────────────────────────┐
                                      │ Capture Result + Errors  │──── All clear ──┐
                                      └────────────┬─────────────┘                 │
                                                   ▼                               │
                                      ┌──────────────────────────┐                 │
                                      ...
                                      └────────────┬─────────────┘                 │
                                            ...
                                            ◇ Harness Checks ◇ ◄──────────────────┘
                                           ╱                  ╲
                              Token limit hit                  Loop detected
                                   ╱                                  ╲
                    ┌──────────────────────┐              ┌────────────────────┐
                    │ Compact / Summarize  │              │  Inject Variation  │
                    └──────────────────────┘              └────────────────────┘
```
...
Progressive disclosure is from UI/UX design, originated by John Carroll at IBM Research in the 1980s, popularized by Jakob Nielsen in the 1990s. The principle: show only what is needed now, reveal complexity on demand.
...
| Technique | Claude Code | Cursor | Manus | SWE-Agent | Devin |
|---|---|---|---|---|---|
| Single flat loop | [C] | [Y] | [Y] | [Y] | [Y] |
| Model-specific harness tuning | [--] | [C] | [--] | [--] | [--] |
| Multi-agent decomposition | [Y] (subagents) | [--] | [alt] (handoffs) | [--] | [Y] (3-tier) |
| Linter-gated edits | [--] | [--] | [--] | [C] | [--] |

### Progressive Disclosure

| Technique | Claude Code | Cursor | Manus | SWE-Agent | Devin |
|---|---|---|---|---|---|
| Lazy tool loading | [--] | [C] (46.9% reduction) | [alt] (logit masking) | [--] | [--] |
| On-demand skill files | [C] (SKILL.md) | [Y] (discoverable files) | [--] | [--] | [Y] (Playbooks) |
| File system as memory | [Y] | [C] (files-as-primitive) | [C] (extended memory) | [--] | [Y] |
| Observation compression | [Y] (compaction at 95%) | [Y] (chat history files) | [Y] (reversible compression) | [C] (collapse to 1 line) | [--] |

### Error Handling & Robustness

| Technique | Claude Code | Cursor | Manus | SWE-Agent | Devin |
|---|---|---|---|---|---|
| Errors preserved in context | [Y] | [--] | [C] | [Y] | [--] |
| System reminders after tool calls | [C] | [--] | [--] | [--] | [--] |
| Loop/fixation detection | [--] | [Y] | [C] (structured variation) | [--] | [--] |
| Plan recitation (todo.md) | [C] (TodoWrite) | [--] | [C] (todo.md rewriting) | [--] | [--] |
