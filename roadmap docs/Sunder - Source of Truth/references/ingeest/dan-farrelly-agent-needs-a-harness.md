...
The last piece that we're exploring to make this truly "universally triggered" is enabling Utah to write itself - building new agents and workflows, creating new webhooks, and monitoring itself via API.
