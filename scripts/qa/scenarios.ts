...
export const scenarios: QaScenario[] = [
  ...
  // ── 05: Knowledge Base ─────────────────────────────────────────────────
  {
    ...
    expectedTools: ["run_agent_memory_sql"],
    sequential: false,
  ...
  // ── 18: Agent Views ────────────────────────────────────────────────────
  {
    ...
    expectedTools: ["search_deals", "show_view"],
    sequential: false,
    notes: "Inline pipeline view.",
  },
  {
    surface: "18-agent-views",
    ...
    expectedTools: ["run_agent_memory_sql", "show_view"],
    sequential: false,
    notes: "StatMetric components.",
  },
  {
    surface: "18-agent-views",
    ...
    expectedTools: ["search_deals", "show_view"],
    sequential: false,
    notes: "BarChartPanel view.",
  },
  {
    surface: "18-agent-views",
    scenario: "contact-donut-chart",
    prompt: "Show me my contact types as a pie chart",
    expectedTools: ["search_contacts", "show_view"],
    sequential: false,
    notes: "DonutChartPanel view.",
  },
  {
    surface: "18-agent-views",
    scenario: "overdue-tasks",
    prompt: "Show me my overdue tasks",
    expectedTools: ["search_tasks", "show_view"],
    sequential: false,
    notes: "TaskItem components.",
  },
];
