  ...
  return (
    <div className="mt-8 space-y-6">
      ...
      {(hasVolume || hasHeatmap) ? (
        <>
          <p className="text-xs font-semibold uppercase tracking-wider text-zinc-400">Activity Overview</p>
          {hasVolume ? (
      ...
      {(hasTransactionType || hasSalesRep || hasRentalRep) ? (
        <>
          <p className="text-xs font-semibold uppercase tracking-wider text-zinc-400">Transaction Breakdown</p>
      ...
      {hasTopNeighbourhoods ? (
        <>
          <p className="text-xs font-semibold uppercase tracking-wider text-zinc-400">Geography</p>
