...
Validates content against Sunder brand guidelines including colors, fonts, tone, and messaging.
"""
...
def get_sunder_guidelines() -> BrandGuidelines:
    """
    Get Sunder Inc. brand guidelines.

    These guidelines match the standards defined in the SKILL.md reference.

    Returns:
        BrandGuidelines object with Sunder standards
    """
    return BrandGuidelines(
        brand_name="Sunder",
        primary_colors=[
            "#2D6A4F",  # NeoBot Green
            "#40916C",  # NeoBot Green Light
            "#1B4332",  # NeoBot Green Dark
            "#FFFFFF",  # White
        ],
        secondary_colors=[
            "#19A249",  # Success Green
            "#D87708",  # Warning Amber
            "#2762EA",  # Info Blue
            "#1F2937",  # Content Gray
            "#E4E4E7",  # Border Gray
            "#F8F9FA",  # Light Gray
        ],
        fonts=["Figtree", "Playfair Display", "DM Sans", "system-ui", "-apple-system", "sans-serif"],
        tone_keywords=[
            "transform",
            "intelligently",
            "streamline",
        ...
        prohibited_words=["cheap", "outdated", "inferior", "complicated", "manual", "tedious"],
...
def main():
    ...
    # Load Sunder brand guidelines
    guidelines = get_sunder_guidelines()
    ...
    Transform your document chaos with our intelligent extraction platform.
    ...
    # Print results
    print("=" * 60)
    print("SUNDER BRAND VALIDATION REPORT")
    print("=" * 60)
