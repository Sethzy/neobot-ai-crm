...
- Source: `src/lib/ai/system-prompt.ts`
- Status: Bootstrap placeholder with interim CRM approval guidance (SAFETY-02)
- Full 7-layer context assembly planned for Phase 2 PR 15
