# @composio/vercel — npm Package README

> Source: https://www.npmjs.com/package/@composio/vercel (verbatim from cloned repo README)
> Repo path: `ts/packages/providers/vercel/README.md`
> Version: 0.6.4
...
When using tools with Vercel AI SDK, you might need to ensure that all tool parameters are marked as required. This is because some LLM APIs require all fields to be marked as required. You can enable strict mode when creating the provider to automatically remove all non-required properties from tool parameters:
