# Claude Code Memory System (Verbatim from Official Docs)

> Source: https://code.claude.com/docs/memory
...
* The first 200 lines of `MEMORY.md` are loaded into Claude's system prompt at the start of every session. Content loaded automatically, and Claude is instructed to keep it concise by moving detailed notes into separate topic files.
...
CLAUDE.md files can import additional files using `@path/to/import` syntax. Example:
