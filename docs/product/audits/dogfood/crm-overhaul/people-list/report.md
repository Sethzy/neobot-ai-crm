# Dogfood Report: Sunder People List

| Field | Value |
|-------|-------|
| **Date** | 2026-03-10 |
| **App URL** | http://localhost:3002/customers/people |
| **Session** | crm-overhaul-dogfood |
| **Scope** | People list page (/customers/people) |
...
1. Navigate to http://localhost:3002/customers/people
