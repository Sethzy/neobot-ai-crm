# Dogfood Report: Sunder Deals List

| Field | Value |
|-------|-------|
| **Date** | 2026-03-10 |
| **App URL** | http://localhost:3002/customers/deals |
| **Session** | crm-overhaul-dogfood |
| **Scope** | Deals list page (/customers/deals) |
...
1. Navigate to http://localhost:3002/customers/deals
